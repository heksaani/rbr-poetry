...
class PoemsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create poem" do
    assert_difference("Poem.count") do
      post poems_url, params: { poem: { name: @poem.name, poem: @poem.poem, poet_id: @poem.poet_id, style: @poem.style } }
    end
  ...
  test "should update poem" do
    patch poem_url(@poem), params: { poem: { name: @poem.name, poem: @poem.poem, poet_id: @poem.poet_id, style: @poem.style } }
